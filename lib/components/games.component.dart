  ...
  Text _playersToListTitle(List<Player> players) {
    if (players.length == 0) {
      return Text('No players added...',
          style: TextStyle(fontSize: 12, fontStyle: FontStyle.normal, color: const Color(0xFF6C7B8A)));
    }
    ...
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Container(
          ...
          padding: const EdgeInsets.only(top: 0, bottom: 0, right: 30, left: 30),
          child: new Row(
            ...
            children: [
              new Container(
                  ...
                  child: new ClipRRect(
                      ...
                      child: Image(
                          image: new AssetImage('assets/game-thumb.png'), fit: BoxFit.cover,
                      )
                  )
              ),
              new Expanded(
                child: new ClipRRect(
                  ...
                  child: new Container(
                      padding: new EdgeInsets.only(top: 25, bottom: 25, left: 20, right: 15),
                      child: new Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          ...
                          children: [
                            new GestureDetector(
                                ...
                                child: new Padding(
                                    ...
                                    child: Text(
                                      game.name,
                                      style: new TextStyle(fontSize: 14, fontWeight: FontWeight.w400, letterSpacing: 0.5,),
                                    ))),
                            new Text(
                                new DateFormat('yMMMMd').format(game.createdAt.toDate()
                                ),
                                style: new TextStyle(fontWeight: FontWeight.w300, fontSize: 12, color: const Color(0xFF6C7B8A)),
                            ),
                            new Container(
              ...
              new Column(children: [
                  new Container(
                    ...
                    child: new PillButton(
                      ...
                      child: new Text('REMATCH', style: new TextStyle(fontSize: 10, fontWeight: FontWeight.w500, letterSpacing: 1, color: const Color(0xFFFFFFFF))),
